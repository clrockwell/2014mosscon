      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="5" align="center" bgcolor="#FFFFFF" style="font-family: verdana, arial, helvetica; font-size: small;">
        ...
        <tr valign="top">
          <td>
            ...
            <p><b><?php echo t('Thank you for registering to attend MOSSCon, !order_first_name!', array('!order_first_name' => $order_first_name)); ?>.
              Your confirmation number is <?php echo $order_link; ?>.</b></p><p>Please help us spread the word about MOSSCon by inviting your friends! <a href="https://twitter.com/intent/tweet?text=I+just+registered+for+@MOSSCon13+-+Register+now+to+get+the+early+bird+discount+http://mosscon.org/register+%23MOSSCon13">This twitter message</a> will give them a link to registration and let them know you&#39;ve already registered!</p>
            ...
            <table cellpadding="4" cellspacing="0" border="0" width="100%" style="font-family: verdana, arial, helvetica; font-size: small;">
              <tr>
                <td colspan="2" bgcolor="#006699" style="color: white;">
                  <b><?php echo t('Registration Information:'); ?></b>
                </td>
              </tr>
              <tr>
                <td nowrap="nowrap">
