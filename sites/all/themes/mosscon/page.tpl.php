...
<head>
  ...
  $logoImage = $base_root . '/' . $theme_path . '/logo.png';
  $pagePath = $base_root . $path;
   ?>
  <?php print $head; ?>
  <title><?php print $head_title; ?></title>
  <meta name="description" content="MOSSCon brings together Free & Open Source Software developers, users, thought-leaders and providers.  The 2013 MOSSCon will be held May 18 - 19 in Louisville, Kentucky.">
  <meta http-equiv="Content-Style-Type" content="text/css" />
  <meta property="og:title" content="<?php print $head_title; ?>" />
  <meta property="og:type" content="website" />
  <meta property="og:url" content="<?php print $pagePath; ?>" />
  <meta property="og:image" content="<?php print $logoImage; ?>" />
                                    ...
                                    <ul>
                                        <?php
                                            ...
                                            if ($user->uid != 0) {
                                                ...
                                                print '<li><a href="' . url('user/register') . '">' . t('Create account') . '</a></li>';
                                            } 
                                        ?>
                                    </ul>
                ...
                <div id="header-first">
                	<div class="restrict-inner">
                      ...
                      <div class="logo">
                          ...
                          <img src="<?php print $logo ?>" alt="<?php print t('Home') ?>"/><br />
                          <span class="conf-title">Midwest Open Source Software Conference</span></a>
                      </div>
